  ...
  void render(Canvas canvas) {
      ...
      if(game.stage.menuManager.last == this){
        ...
        List<TextEntry> stats = [
          ...
          TextEntry("${unit.getStat("mag")}", Stage.tileSize*6, lineHeight*4, Anchor.topRight),
          TextEntry("Resistance:", Stage.tileSize*.25, lineHeight*5, Anchor.topLeft),
          TextEntry("${unit.getStat("res")}", Stage.tileSize*6, lineHeight*5, Anchor.topRight),
