...
class Cursor extends PositionComponent with HasGameReference<MoiraGame>, HasVisibility {
  ...
  void update(double dt) {
    super.update(dt);
    if (game.world == game.stage && game.stage.activeFaction?.factionType == FactionType.blue && game.stage.eventQueue.currentBatch().isEmpty){isVisible = true;} else {isVisible = false;}
    if (isMoving) {
