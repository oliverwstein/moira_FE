...
class MoiraGame extends FlameGame with KeyboardEvents {
  ...
  Future<void> onLoad() async {
    ...
    List<String> portraitNames = ["", "Villager", "Gerrard", "DiMaggio", "Lex", "Azel", "Gandolf", "Aideen", "Midir", "Arden", "Noish", "Alec", "Sigurd", "Oifey", "Quan", "Ethlyn", "Finn", "Arvis", "Filat"];
    ...
    UnitExhaustEvent.initialize(eventQueue);
