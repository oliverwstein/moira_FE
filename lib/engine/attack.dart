...
class Attack extends Component with HasGameRef<MyGame>{
  ...
  Attack._internal(this.name, this.description, this.scaling, this.weaponTypes, this.might, this.hit, this.fatigue, this.magic, this.range, this.effects);
  ...
  factory Attack.fromJson(String name) {
    ...
    return Attack._internal(name, description, scaling, weaponTypes, might, hit, fatigue, magic, range, null);
  }
}
